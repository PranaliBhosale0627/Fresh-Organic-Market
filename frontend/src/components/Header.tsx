...
export default function Header({
  ...
  return (
    <>
      <header className="bg-white border-b border-outline-variant/30 sticky top-0 z-[100] shadow-sm">
        <div className="flex justify-between items-center px-4 md:px-12 py-3.5 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-6">
            {!isAdminMode ? (
              ...
              >
                <div className="bg-secondary-container p-2 rounded-full text-on-secondary-container transition-transform group-hover:scale-105">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-primary flex items-center gap-1 group-hover:underline">
                    {currentLocation}
                  </p>
                </div>
              </div>
          ...
          >
            <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white font-bold font-headline-md shadow-md shadow-primary/20">
              V
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {(currentUser?.isAdmin || isAdminMode) && (
              <div className="flex bg-surface-container-low p-1 rounded-full border border-outline-variant/50 shadow-inner mr-2">
                <button
                  onClick={() => {
            ...
            {currentUser ? (
              <div className="flex items-center gap-2">
                <div 
                  ...
                  className="flex items-center gap-2 cursor-pointer bg-surface-container-low hover:bg-surface-container border border-outline-variant/30 px-3 py-1.5 rounded-full shadow-sm transition-all"
                >
              ...
              <button
                ...
                className="bg-primary hover:bg-primary-container text-white hover:text-primary border border-primary/20 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider shadow transition-all duration-150 flex items-center gap-1.5 active:scale-95 cursor-pointer"
              >
            ...
            <div className="relative">
              ...
              {showNotificationsDropdown && (
                <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl border border-outline-variant/50 shadow-xl z-[150] p-4 space-y-3">
                  ...
                  <div className="max-h-60 overflow-y-auto space-y-2">
                    {notifications.length === 0 ? (
                      ...
                      notifications.map((notif, idx) => (
                        <div key={idx} className="bg-surface-container-low p-2.5 rounded-xl border border-outline-variant/25 text-[11px] text-on-surface leading-normal text-left">
                          {notif}
                        </div>
                      ))
                    )}
      ...
      {showLocationModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[1000] flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-6 max-w-md w-full shadow-2xl border border-outline-variant/30 transition-all duration-300">
