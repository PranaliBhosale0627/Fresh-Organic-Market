const INITIAL_PRODUCTS = [
  {
    ...
    rating: 4.8,
    reviewsCount: 340,
    nutritionalFacts: { calories: 49, fat: '0.9g', fiber: '3.6g', protein: '4.3g', details: 'Supercharged with vitamins A, K, and C, manganese, and powerful antioxidants.' },
    origin: { farm: 'Verdant Fields Farm', location: 'Sonoma County, CA', badges: ['Certified Organic', 'Biodynamic Soil'] }
  },
  {
    ...
    rating: 4.7,
    reviewsCount: 180,
    nutritionalFacts: { calories: 22, fat: '0.2g', fiber: '1.5g', protein: '1.1g', details: 'Excellent source of lycopene, vitamin C, potassium, and folate.' },
    origin: { farm: 'Red Hills Organics', location: 'Napa Valley, CA', badges: ['Pesticide Free', 'Water Conservation'] }
  },
  {
    id: 'prod-avocados',
    ...
    rating: 4.9,
    reviewsCount: 1200,
    nutritionalFacts: { calories: 160, fat: '15g', fiber: '7g', protein: '2g', details: 'Abundant in monounsaturated heart-healthy fats, vitamin E, potassium, and B-complex vitamins.' },
    origin: { farm: 'Verde Valley Farms', location: 'Sonoma County, CA', badges: ['Certified Regenerative', 'Hand-Picked Daily'] }
  },
  {
    id: 'prod-asparagus',
    name: 'Baby Asparagus',
    ...
    rating: 4.6,
    reviewsCount: 95,
    nutritionalFacts: { calories: 20, fat: '0.1g', fiber: '2.1g', protein: '2.2g', details: 'High in folic acid, selenium, and vitamins K, A, and C.' },
    origin: { farm: 'Marin Greenhouses', location: 'Marin County, CA', badges: ['Local Sourced', 'Carbon Neutral'] }
  },
  {
    id: 'prod-carrots',
    ...
    rating: 4.8,
    reviewsCount: 210,
    nutritionalFacts: { calories: 41, fat: '0.2g', fiber: '2.8g', protein: '0.9g', details: 'Loaded with beta-carotene, antioxidants, and dietary fibers.' },
    origin: { farm: 'Sunsoil Root Farms', location: 'Sacramento Valley, CA', badges: ['Certified Organic', 'No Synthetic Sprays'] }
  },
  {
    id: 'prod-cauliflower',
    ...
    rating: 4.9,
    reviewsCount: 74,
    nutritionalFacts: { calories: 25, fat: '0.3g', fiber: '2g', protein: '1.9g', details: 'Distinctive color is rich in anthocyanins, powerful anti-inflammatory agents.' },
    origin: { farm: 'Heritage Seed Farms', location: 'Healdsburg, CA', badges: ['Heirloom Seed', 'Beetle-Protected Netting'] }
  },
  {
    id: 'prod-bellpeppers',
    ...
    rating: 4.7,
    reviewsCount: 165,
    nutritionalFacts: { calories: 31, fat: '0.3g', fiber: '2.1g', protein: '1g', details: 'Superb source of Vitamin C and Vitamin A for skin and immune support.' },
    origin: { farm: 'Coastal Fields', location: 'Santa Cruz, CA', badges: ['USDA Certified Organic', 'Drip-Irrigated'] }
  },
  {
    id: 'prod-spinach',
    name: 'Baby Spinach',
    ...
    rating: 4.8,
    reviewsCount: 412,
    nutritionalFacts: { calories: 23, fat: '0.4g', fiber: '2.2g', protein: '2.9g', details: 'Abundant in iron, calcium, magnesium, and dietary folic acid.' },
    origin: { farm: 'Salad Bowl Orchards', location: 'Salinas Valley, CA', badges: ['Triple Washed', 'Hydro-cooled'] }
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 520,
    nutritionalFacts: { calories: 18, fat: '0.2g', fiber: '1.2g', protein: '0.9g', details: 'High concentration of antioxidant lycopene and beta-carotene.' },
    origin: { farm: 'Organic Gardens Inc', location: 'Sonoma County, CA', badges: ['Certified Organic', 'Hand-picked'] }
  },
  {
    id: 'prod-sourdough',
    ...
    rating: 4.9,
    reviewsCount: 840,
    nutritionalFacts: { calories: 250, fat: '1.2g', fiber: '2.4g', protein: '9g', details: 'Fermented naturally for over 36 hours for easy digestion and delicious tang.' },
    origin: { farm: 'Wild Yeast Bakery', location: 'San Francisco, CA', badges: ['Slow Fermented', 'Stone-milled Flour'] }
  },
  {
    id: 'prod-microgreens',
    ...
    rating: 4.8,
    reviewsCount: 145,
    nutritionalFacts: { calories: 30, fat: '0.4g', fiber: '2g', protein: '3g', details: 'Contains up to 40 times higher nutrient concentrations than mature greens.' },
    origin: { farm: 'Zesty & Fresh Co', location: 'San Jose, CA', badges: ['Live Soil Pots', 'Zero Waste'] }
  },
  {
    id: 'prod-milk',
    ...
    rating: 4.8,
    reviewsCount: 380,
    nutritionalFacts: { calories: 149, fat: '8g', fiber: '0g', protein: '8g', details: 'Packed with calcium, Vitamin D3, and healthy Omega-3 fats.' },
    origin: { farm: 'Happy Cows Meadow', location: 'Marin County, CA', badges: ['100% Grass-Fed', 'Family Owned'] }
  },
  {
    id: 'prod-croissants',
    ...
    rating: 4.8,
    reviewsCount: 195,
    nutritionalFacts: { calories: 320, fat: '18g', fiber: '2.5g', protein: '6g', details: 'Handcrafted with stone-ground organic wheat flour and premium pasture butter.' },
    origin: { farm: 'Wild Yeast Bakery', location: 'San Francisco, CA', badges: ['Organic Ingredients', 'Baked Daily'] }
  },
  {
    id: 'prod-seeded-loaf',
    ...
    rating: 4.7,
    reviewsCount: 110,
    nutritionalFacts: { calories: 210, fat: '4.5g', fiber: '6g', protein: '8g', details: 'Superb source of fiber and essential seed minerals. Free from additives.' },
    origin: { farm: 'Wild Yeast Bakery', location: 'San Francisco, CA', badges: ['Slow Fermented', 'Ancient Grains'] }
  },
  {
    ...
    rating: 4.9,
    reviewsCount: 315,
    nutritionalFacts: { calories: 180, fat: '7g', fiber: '3g', protein: '4g', details: 'Naturally sweetened with maple syrup and pure vanilla bean extract.' },
    origin: { farm: 'Marin Greenhouses', location: 'Marin County, CA', badges: ['Gluten-Free Cert.', 'No Refined Sugar'] }
  },
  {
    id: 'prod-butter',
    ...
    rating: 4.9,
    reviewsCount: 220,
    nutritionalFacts: { calories: 100, fat: '11g', fiber: '0g', protein: '0.1g', details: 'High in Vitamin A, beta-carotene, and healthy CLA fatty acids.' },
    origin: { farm: 'Happy Cows Meadow', location: 'Marin County, CA', badges: ['100% Grass-Fed', 'Traditional Churn'] }
  },
  {
    id: 'prod-yogurt',
    ...
    rating: 4.8,
    reviewsCount: 167,
    nutritionalFacts: { calories: 130, fat: '4g', fiber: '0g', protein: '15g', details: 'Contains 5 strains of live probiotic cultures for digestive health.' },
    origin: { farm: 'Happy Cows Meadow', location: 'Marin County, CA', badges: ['Pasture Raised', 'Rich in Protein'] }
  },
  {
    id: 'prod-cheddar',
    ...
    rating: 4.9,
    reviewsCount: 280,
    nutritionalFacts: { calories: 110, fat: '9g', fiber: '0g', protein: '7g', details: 'Excellent source of calcium, phosphorus, and vitamin B12.' },
    origin: { farm: 'Happy Cows Meadow', location: 'Marin County, CA', badges: ['Grass-Fed Milk', 'Aged to Perfection'] }
  }
];
